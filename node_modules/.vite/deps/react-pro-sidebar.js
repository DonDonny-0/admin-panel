...
//#region node_modules/react-pro-sidebar/dist/index.es.js
...
var ProSidebar = function(_a, ref) {
	var children = _a.children, className = _a.className, width = _a.width, collapsedWidth = _a.collapsedWidth, collapsed = _a.collapsed, rtl = _a.rtl, toggled = _a.toggled, image = _a.image, breakPoint = _a.breakPoint, onToggle = _a.onToggle, _b = _a.style, style = _b === void 0 ? {} : _b, rest = __rest(_a, [
		"children",
		"className",
		"width",
		"collapsedWidth",
	...
	var sidebarRef = ref || import_react.createRef();
	...
	var finalWidth = collapsed ? collapsedWidth ? {
	...
	(0, import_react.useEffect)(function() {
		setSidebarState(__assign(__assign({}, sidebarState), {
			collapsed,
			rtl,
			toggled
		}));
	...
	return import_react.createElement(SidebarContext.Provider, { value: sidebarState }, import_react.createElement("div", __assign({
		ref: sidebarRef,
		...
		style: __assign(__assign({}, finalWidth), style)
	}, rest), import_react.createElement("div", { className: "pro-sidebar-inner" }, image ? import_react.createElement("img", {
		src: image,
		alt: "sidebar background",
		className: "sidebar-bg"
	}) : null, import_react.createElement("div", { className: "pro-sidebar-layout" }, children)), import_react.createElement("div", {
		className: "overlay",
...
var SidebarHeader = function(_a, ref) {
	...
	var sidebarHeaderRef = ref || import_react.createRef();
...
var SidebarContent = function(_a, ref) {
	var children = _a.children, className = _a.className, rest = __rest(_a, ["children", "className"]);
	var sidebarContentRef = ref || import_react.createRef();
	return import_react.createElement("div", __assign({
...
var SidebarFooter = function(_a, ref) {
	var children = _a.children, className = _a.className, rest = __rest(_a, ["children", "className"]);
	var sidebarFooterRef = ref || import_react.createRef();
	return import_react.createElement("div", __assign({
...
var Menu = function(_a, ref) {
	var _b;
	var children = _a.children, className = _a.className, iconShape = _a.iconShape, _c = _a.popperArrow, popperArrow = _c === void 0 ? false : _c, _d = _a.subMenuBullets, subMenuBullets = _d === void 0 ? false : _d, _e = _a.innerSubMenuArrows, innerSubMenuArrows = _e === void 0 ? true : _e, rest = __rest(_a, [
		"children",
		"className",
		"iconShape",
		"popperArrow",
	...
	var menuRef = ref || import_react.createRef();
	return import_react.createElement("nav", __assign({
		ref: menuRef,
		className: classnames("pro-menu", className, (_b = {}, _b["shaped " + iconShape] = [
			"square",
			"round",
			"circle"
		].indexOf(iconShape) >= 0, _b["submenu-bullets"] = subMenuBullets, _b["inner-submenu-arrows"] = innerSubMenuArrows, _b))
	}, rest), import_react.createElement("ul", null, import_react.Children.toArray(children).filter(Boolean).map(function(child, index) {
...
var MenuItem = function(_a, ref) {
	var children = _a.children, className = _a.className, icon = _a.icon, active = _a.active, prefix = _a.prefix, suffix = _a.suffix;
	_a.firstchild;
	_a.popperarrow;
	var rest = __rest(_a, [
		"children",
	...
	var menuItemRef = ref || import_react.createRef();
	return import_react.createElement("li", __assign({
		ref: menuItemRef,
		className: classnames("pro-menu-item", className, { active })
	}, rest), import_react.createElement("div", {
		className: "pro-inner-item",
		tabIndex: 0,
		role: "button"
	}, icon ? import_react.createElement("span", { className: "pro-icon-wrapper" }, import_react.createElement("span", { className: "pro-icon" }, icon)) : null, prefix ? import_react.createElement("span", { className: "prefix-wrapper" }, prefix) : null, import_react.createElement("span", { className: "pro-item-content" }, children), suffix ? import_react.createElement("span", { className: "suffix-wrapper" }, suffix) : null));
};
	...
	var SlideDownContent = function(_super) {
		...
		function SlideDownContent(props) {
			...
			_this.handleRef = function(ref) {
				_this.outerRef = ref;
				if (_this.props.forwardedRef) if (typeof _this.props.forwardedRef === "function") _this.props.forwardedRef(ref);
				else if (typeof _this.props.forwardedRef === "object") {
					var forwardedRef = _this.props.forwardedRef;
					forwardedRef.current = ref;
				} else throw new Error("Invalid forwardedRef " + _this.props.forwardedRef);
			};
			_this.handleTransitionEnd = function(evt) {
				if (evt.target === _this.outerRef && evt.propertyName === "height") if (_this.state.childrenLeaving) _this.setState({
					children: null,
					childrenLeaving: false
				}, function() {
					return _this.endTransition();
				});
				else _this.endTransition();
			};
			_this.state = {
		...
		SlideDownContent.prototype.componentDidMount = function() {
			if (this.outerRef) if (this.props.closed || !this.props.children) {
				this.outerRef.classList.add("closed");
				this.outerRef.style.height = "0px";
			} else if (this.props.transitionOnAppear) this.startTransition("0px");
			else this.outerRef.style.height = "auto";
		};
		...
		SlideDownContent.prototype.componentDidUpdate = function(_prevProps, _prevState, snapshot) {
			if (this.outerRef) this.startTransition(snapshot);
		};
		...
		SlideDownContent.prototype.endTransition = function() {
			...
			if (this.props.closed || !this.state.children) this.outerRef.classList.add("closed");
		};
		SlideDownContent.prototype.render = function() {
			var _a = this.props, _b = _a.as, as = _b === void 0 ? "div" : _b;
			_a.children;
			var className = _a.className;
			_a.closed;
			_a.transitionOnAppear;
			_a.forwardedRef;
...
function getTrueOffsetParent(element) {
	...
	if (offsetParent) {
		...
		if (getNodeName(offsetParent) === "body" && getComputedStyle$1(offsetParent).position === "static" && getComputedStyle$1(html).position !== "static") return html;
	}
	return offsetParent;
}
		...
		Object.keys(modifier).forEach(function(key) {
			switch (key) {
				case "name":
					...
					break;
				case "enabled": if (typeof modifier.enabled !== "boolean") console.error(format(INVALID_MODIFIER_ERROR, modifier.name, "\"enabled\"", "\"boolean\"", "\"" + String(modifier.enabled) + "\""));
				case "phase":
...
function getDocumentRect(element) {
	...
	if (getComputedStyle$1(body || html).direction === "rtl") x += Math.max(html.clientWidth, body ? body.clientWidth : 0) - width;
	return {
		width,
		height,
		x,
...
function distanceAndSkiddingToXY(placement, rects, offset) {
	...
	var _ref = typeof offset === "function" ? offset(Object.assign(Object.assign({}, rects), {}, { placement })) : offset, skidding = _ref[0], distance = _ref[1];
	skidding = skidding || 0;
...
function preventOverflow(_ref) {
	...
	var referenceRect = state.rects.reference;
	var popperRect = state.rects.popper;
	var tetherOffsetValue = typeof tetherOffset === "function" ? tetherOffset(Object.assign(Object.assign({}, state.rects), {}, { placement: state.placement })) : tetherOffset;
	var data = {
		x: 0,
		y: 0
	};
	...
	if (checkAltAxis) {
		...
		var _preventedOffset = within(_offset + overflow[_mainSide], _offset, _offset - overflow[_altSide]);
...
function effect$2(_ref2) {
	...
	state.modifiersData[name + "#persistent"] = { padding: mergePaddingObject(typeof padding !== "number" ? padding : expandToHashMap(padding, basePlacements)) };
}
var arrow$1 = {
	name: "arrow",
	enabled: true,
...
var SubMenu = function(_a, ref) {
	var children = _a.children, icon = _a.icon, className = _a.className, title = _a.title, _b = _a.defaultOpen, defaultOpen = _b === void 0 ? false : _b, open = _a.open, prefix = _a.prefix, suffix = _a.suffix, firstchild = _a.firstchild, popperarrow = _a.popperarrow, onOpenChange = _a.onOpenChange, rest = __rest(_a, [
		"children",
		"icon",
		"className",
		"title",
	...
	(0, import_react.useEffect)(function() {
		if (firstchild) {
			if (collapsed) {
				if (referenceElement.current && popperElement.current) popperInstance = createPopper(referenceElement.current, popperElement.current, {
					placement: "right",
					strategy: "fixed",
					modifiers: [{
						name: "computeStyles",
	...
	var subMenuRef = ref || import_react.createRef();
	return import_react.createElement("li", __assign({
		ref: subMenuRef,
		className: classnames("pro-menu-item pro-sub-menu", className, { open: typeof open === "undefined" ? !closed : open })
	}, rest), import_react.createElement("div", {
		...
		role: "button",
		tabIndex: 0
	}, icon ? import_react.createElement("span", { className: "pro-icon-wrapper" }, import_react.createElement("span", { className: "pro-icon" }, icon)) : null, prefix ? import_react.createElement("span", { className: "prefix-wrapper" }, prefix) : null, import_react.createElement("span", { className: "pro-item-content" }, title), suffix ? import_react.createElement("span", { className: "suffix-wrapper" }, suffix) : null, import_react.createElement("span", { className: "pro-arrow-wrapper" }, import_react.createElement("span", { className: "pro-arrow" }))), firstchild && collapsed ? import_react.createElement("div", {
		ref: popperElement,
		...
		ref: popperElRef
	}, import_react.createElement("ul", null, children)), popperarrow ? import_react.createElement("div", {
		className: "popper-arrow",
		"data-popper-arrow": true
	}) : null) : import_react.createElement(SlideDown, {
		closed: typeof open === "undefined" ? closed : !open,
		className: "pro-inner-list-item"
	}, import_react.createElement("div", null, import_react.createElement("ul", null, children))));
};
